...
Використовуючи -fsanitize=address для програми, де навмисно створив витік пам'яті та переповнення буфера, спостерігав, що -fsanitize=address реагує лише на переповнення, але не на витік.
